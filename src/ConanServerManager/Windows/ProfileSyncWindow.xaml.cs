...
namespace ServerManagerTool
{
    ...
    public partial class ProfileSyncWindow : Window
    {
        ...
        private void CreateSyncSectionList()
        {
            ...
            SyncSections.Add(new SyncSection() { Selected = false, Category = ServerProfileCategory.ScriptFiles, SectionName = _globalizer.GetResourceString("ServerSettings_ScriptFilesLabel") });
        }
